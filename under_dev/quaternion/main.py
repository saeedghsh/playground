...
# * then: the rotation of it will not take effect, i.e. the end pose will have the same orientation
# * then: also the plotting fails to plot it! is it a but in quiver?
